...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score_11), "AB_Custom_11"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_12), "AB_Custom_12"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_13), "AB_Custom_13")
    ]
