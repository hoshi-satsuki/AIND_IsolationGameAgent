...
if __name__ == "__main__":
    ...
    from game_agent import (MinimaxPlayer, AlphaBetaPlayer, custom_score,custom_score_2)
    ...
    # players take turns moving on the board, so play0er1 should be next to move
